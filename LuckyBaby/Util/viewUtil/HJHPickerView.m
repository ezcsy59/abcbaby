...
@interface HJHPickerView ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
-(void)setPickerV{
    ...
    pBgV.frame = CGRectMake(10, (iPhone5?568:480) - 335, 300, 200);
    ...
    self.pickerView.frame = CGRectMake(0, 0, 300, 200);
...
#pragma btnClick
-(void)cancalbClicked{
    [self.delegate2 hjhCancalbClicked];
}
...
-(void)quebClicked{
    ...
    NSString *provinceStr = [self.pickerArray1 objectAtIndex: provinceIndex%5000];
    NSString *cityStr = [self.pickerArray2 objectAtIndex: cityIndex%12];
    NSString *districtStr = @"";
    switch (cityIndex%12) {
        case 0:case 2:case 4:case 6:case 7:case 9:case 11:
        {
            districtStr = [self.pickerArray3 objectAtIndex:districtIndex%31];
        }
            break;
        case 3:case 5:case 8:case 10:
        {
            districtStr = [self.pickerArray3 objectAtIndex:districtIndex%30];
        }
            break;
        case 1:
        {
            districtStr = [self.pickerArray3 objectAtIndex:districtIndex%28];
        }
            break;
    ...
    NSString *areaB = [areaA stringByReplacingOccurrencesOfString:@" " withString:@"-"];
    
    [self.delegate2 hjhGetDifang:areaB];
}
@end
