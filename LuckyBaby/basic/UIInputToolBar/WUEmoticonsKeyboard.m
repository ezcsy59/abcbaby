...
- (void)layoutSubviews {
    ...
    [self.keyItemGroupViews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger idx, BOOL *stop) {
        CGRect r = self.keyItemGroupViewFrame;
        //2014.01.17 改变view.frame的高度，增加55
        r.size.height += 55;
        view.frame = r;
    }];
}
...
- (void)reloadKeyItemGroupViews {
    ...
    //2014.01.17 设置groundFrame
    [self.keyItemGroups enumerateObjectsUsingBlock:^(WUEmoticonsKeyboardKeyItemGroup *obj, NSUInteger idx, BOOL *stop) {
        
        //增加r 的55个高度
        CGRect r = weakSelf.keyItemGroupViewFrame;
        r.size.height += 55;
        
        WUEmoticonsKeyboardKeyItemGroupView *keyItemGroupView = [[WUEmoticonsKeyboardKeyItemGroupView alloc] initWithFrame:r];
