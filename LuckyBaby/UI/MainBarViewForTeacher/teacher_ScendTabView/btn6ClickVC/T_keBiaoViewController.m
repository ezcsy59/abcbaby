...
@interface T_keBiaoViewController ()
@property(nonatomic,strong)NSMutableArray *keChengBiaoArray;
@property(nonatomic,strong)NSString *classId;
@end

@implementation T_keBiaoViewController
...
-(void)getData{
    ...
    [youErYuanNetWork1 getCourseSchedulePlatformWeekWithClassId:self.classId semesterId:[DictionaryStringTool stringFromDictionary:dic forKey:@"semesterId"]  platformId:[DictionaryStringTool stringFromDictionary:dic forKey:@"platformId"]];
}
...
-(void)getCourseSchedulePlatformWeekSuccess:(NSNotification*)noti{
    ...
    if ([dict isKindOfClass:[NSDictionary class]]) {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            if (i > 23 && i < 30) {
                NSDictionary *dayDic = [arr objectAtIndex:5];
                NSArray *dayArr = [dayDic objectForKey:@"courseUnitList"];
