...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(saveScoreWeekSuccess:) name:@"saveScoreWeekSuccess" object:nil];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(saveScoreWeekFail:) name:@"saveScoreWeekFail" object:nil];
}
...
-(void)saveScoreWeekSuccess:(NSNotification*)noti{
    [self.navigationController popViewControllerAnimated:YES];
}

-(void)saveScoreWeekFail:(NSNotification*)noti{
...
-(void)saveBtnClick{
    ...
    [tNet saveScoreWeekWithPlatformId:[DictionaryStringTool stringFromDictionary:dic forKey:@"platformId"] semesterId:[DictionaryStringTool stringFromDictionary:dic forKey:@"platformId"] classId:[DictionaryStringTool stringFromDictionary:dic forKey:@"platformId"] weekIndex:@"1" teacherId:[DictionaryStringTool stringFromDictionary:dic forKey:@"platformId"] scoreDesc:@"" childIdList:stringId childNameList:stringName scoreList:@"" dateStart:@"" dateEnd:@""];
}
