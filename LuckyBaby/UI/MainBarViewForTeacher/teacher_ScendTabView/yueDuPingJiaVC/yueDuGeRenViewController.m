...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(saveScoreMonthSuccess:) name:@"saveScoreMonthSuccess" object:nil];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(saveScoreMonthFail:) name:@"saveScoreMonthFail" object:nil];
}
...
-(void)saveScoreMonthSuccess:(NSNotification*)noti{
    [self.navigationController popViewControllerAnimated:YES];
}

-(void)saveScoreMonthFail:(NSNotification*)noti{
...
-(void)saveBtnClick{
    ...
    [tNet saveScoreMonthWithPlatformId:[DictionaryStringTool stringFromDictionary:dic forKey:@"platformId"] semesterId:[DictionaryStringTool stringFromDictionary:dic forKey:@"semesterId"] classId:[DictionaryStringTool stringFromDictionary:dic forKey:@"classId"] monthName:@"201505" teacherId:[DictionaryStringTool stringFromDictionary:dic forKey:@"teacherId"] scoreDesc:@"" childIdList:stringId childNameList:stringName];
}
