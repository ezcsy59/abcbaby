...
@protocol SY_DateViewControllerDelegate <NSObject>
...
@interface SY_DateViewController : UIViewController
{
...
@property(nonatomic,assign)id<SY_DateViewControllerDelegate> delegate2;
@end
