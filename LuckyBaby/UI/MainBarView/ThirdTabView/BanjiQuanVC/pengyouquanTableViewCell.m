...
-(void)resetViewView:(NSDictionary *)dic{
    ...
    [self.leftMinganImageV setImageWithURL:[NSURL URLWithString:[DictionaryStringTool stringFromDictionary:dic forKey:@"headImgUrl"]] placeholderImage:[UIImage imageNamed:@"ic_picture_loading"]];
}
