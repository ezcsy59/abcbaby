...
-(void)getData{
    ...
    [youE listMedicineWithChildIdPlatform:[DictionaryStringTool stringFromDictionary:dic forKey:@"childId"] classId:[DictionaryStringTool stringFromDictionary:dic forKey:@"classId"] page:[NSString stringWithFormat:@"%d",self.currentPage] pageSize:@"10"];
}
