...
@implementation qinListTableViewCell3
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.leftLabel1.frame = CGRectMake(20 + 75, 11 + 4, 150, 18);
        self.leftLabel1.font = [UIFont systemFontOfSize:12];
        ...
        self.leftLabel2.frame = CGRectMake(20 + 75, 45, 150, 18);
