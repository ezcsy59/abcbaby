...
@interface baoBaoBinLiViewController ()
//bar栏的img
...
-(void)setTabBar{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        switch (i) {
            case 0:
                [tabButton setTitle:@"病历本" forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"bingl_b.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"bingl_b_b.png"] forState:UIControlStateSelected];
                break;
            case 1:
                [tabButton setTitle:@"病历史" forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"jib_s.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"jib_s_b.png"] forState:UIControlStateSelected];
                break;
            case 2:
                [tabButton setTitle:@"过敏史" forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"guom_s.png"] forState:UIControlStateNormal];
                [tabButton setImage:[UIImage imageNamed:@"guom_s_b.png"] forState:UIControlStateSelected];
                break;
            default:
                break;
        }
        [tabButton setImageEdgeInsets:UIEdgeInsetsMake(6, 33, 21, 33)];
        [tabButton setTitleEdgeInsets:UIEdgeInsetsMake(40, -42, 0, 0)];
...
-(void)choseView:(NSInteger)page{
    ...
    switch (page) {
        ...
        case 1:
        {
            ...
            if (!self.secondTabVC) {
                self.secondTabVC = [[BinLiShiViewController alloc]init];
            }
...
-(void)addData{
    NewBinLiTableViewController *nVC = [[NewBinLiTableViewController alloc]init];
