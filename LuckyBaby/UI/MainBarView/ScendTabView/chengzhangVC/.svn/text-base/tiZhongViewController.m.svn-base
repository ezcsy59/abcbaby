...
@interface tiZhongViewController ()
...
-(void)viewWillAppear:(BOOL)animated{
    [self getData];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(listWeightRefSuccess:) name:@"listWeightRefSuccess" object:nil];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(listWeightRefFail:) name:@"listWeightRefFail" object:nil];
}
...
-(void)getData{
    ...
    [jianKangNetWork1 listWeightRefWithGender:[DictionaryStringTool stringFromDictionary:dic forKey:@"childGender"]];
}

-(void)listWeightRefSuccess:(NSNotification*)noti{
    ...
    SHView *sV = [[SHView alloc]initWithFrame:CGRectZero andxAxisValues:array1 plottingValues:array2 plottingPointsLabels:array3 ageArray:array4 topHeight:44];
    [scrollView addSubview:sV];
}

-(void)listWeightRefFail:(NSNotification*)noti{
